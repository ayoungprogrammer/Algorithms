public class DFS {
  ...
  /**
   * Performs a DFS on a binary tree tree - current tree DFS is at
   */
  ...
  /**
   * Performs a DFS on a graph adjMatrix - Adjacency matrix for a graph with
   * positive edges. 0 indicates no edge. cur - Current node the DFS is at
